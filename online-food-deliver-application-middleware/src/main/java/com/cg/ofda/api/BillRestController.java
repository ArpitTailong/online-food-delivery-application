...
public class BillRestController {
	...
	/*
	 *to retrieve bill by customer id  
	 * return : bill
	 * params : customerId
	 * */
	@GetMapping("/customer/{customerId}")
	public ResponseEntity<List<BillModel>> viewBillByCustomer(@PathVariable("customerId") Long customerId) throws BillException, CustomerException {
		ResponseEntity<List<BillModel>> response = null;
		List<BillModel> bill = billService.viewAllBillsByCustomer(customerId);
