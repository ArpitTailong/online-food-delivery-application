...
public class CartRestController {
	...
	/*
	 * to modify a cart by adding items
	 * return : cart
	 * params : NIL
	 */
	
	@PostMapping("/items")
	public ResponseEntity<FoodCartModel> addItemsToCart(@RequestBody FoodCartModel cart, @RequestBody ItemModel item) throws CartException, ItemException {
		cart = cartService.addItemsToCart(cart,item);
	...
	public ResponseEntity<FoodCartModel> viewCartByCustomer(@PathVariable("customerId") Long customerId) throws CartException, CustomerException {
		ResponseEntity<FoodCartModel> response = null;
		FoodCartModel cart = cartService.getCartByCustomer(customerId);
