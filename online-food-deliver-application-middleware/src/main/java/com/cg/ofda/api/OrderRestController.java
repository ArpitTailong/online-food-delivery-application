...
public class OrderRestController {
	...
	public ResponseEntity<List<OrderDetailsModel>> viewAllOrdersByCustomer(@PathVariable("customerId") Long customerId) throws OrderException, CustomerException {
		ResponseEntity<List<OrderDetailsModel>> response = null;
		List<OrderDetailsModel> order = orderService.viewAllOrdersByCustomer(customerId);
		if (order == null) {
			response = new ResponseEntity<>(HttpStatus.NOT_FOUND);
		} else {
			response = new ResponseEntity<>(order, HttpStatus.OK);
