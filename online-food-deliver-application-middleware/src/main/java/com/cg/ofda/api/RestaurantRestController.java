...
public class RestaurantRestController {
	...
	/*
	 * to retrieve all restaurant
	 * return : List<restaurants>
	 * params : itemName
	 */
	@GetMapping("/item/{itemName}")
	public ResponseEntity<List<RestaurantModel>> viewAllRestaurantByItem(@PathVariable("itemName") String itemName) throws RestaurantException, ItemException {
		List<RestaurantModel> rest = restaurantService.viewAllRestaurantByItem(itemName);
		if (rest == null) {
