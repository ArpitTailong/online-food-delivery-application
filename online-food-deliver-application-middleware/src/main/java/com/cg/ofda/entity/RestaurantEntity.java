...
public class RestaurantEntity implements Serializable {
	 ...
	 */
	public RestaurantEntity(Long restaurantId,String restaurantName, AddressModel address, ItemEntity items,
	...
	public String toString() {
		return String.format(
				"RestaurantEntity [restaurantId=%s, restaurantName=%s, address=%s, items=%s, managerName=%s, contactNumber=%s]",
				restaurantId, restaurantName, address, items, managerName, contactNumber);
	}
