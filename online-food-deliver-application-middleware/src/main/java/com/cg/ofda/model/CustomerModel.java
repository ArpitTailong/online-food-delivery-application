...
public class CustomerModel {
	...
	@Min(value=13,message="min age should be 13")
	/*For checking age should be less than 70*/
	@Max(value=80,message="max age should be 70")
	private String age;
	
	/*To check mobile number is valid*/
	@Pattern(regexp = "[789]{1}[0-9]{9}", message = "Mobile number should be valid")
