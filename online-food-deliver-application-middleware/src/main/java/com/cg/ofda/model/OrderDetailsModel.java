...
public class OrderDetailsModel {
	...
	public OrderDetailsModel(@NotNull(message = "Order id cannot be null") Long orderId,
			@PastOrPresent(message = "disbursement date cannot be future date") LocalDate orderDate,
	...
	public String toString() {
		return String.format("OrderDetailsModel [orderId=%s, orderDate=%s, cartId=%s, orderStatus=%s, bill=%s]",
				orderId, orderDate, cartId, orderStatus, bill);
	}
