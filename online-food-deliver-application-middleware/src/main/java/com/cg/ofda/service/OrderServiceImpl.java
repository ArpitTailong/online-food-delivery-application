...
public class OrderServiceImpl implements IOrderService {
	...
	@Override
	public List<OrderDetailsModel> viewAllOrdersByCustomer(Long customerId) throws OrderException, CustomerException {
		...
		List<OrderDetailsEntity> order= cart.getOrders();
		
		return order.stream().map(parser::parse).collect(Collectors.toList());
	}
